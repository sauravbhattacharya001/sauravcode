...
class Interpreter:
    ...
    def _builtin_stdev(self, args):
        """stdev(list) -> population standard deviation of a list of numbers."""
    ...
    def _builtin_variance(self, args):
        """variance(list) -> population variance of a list of numbers."""
    ...
    def _builtin_mode(self, args):
        """mode(list) -> most frequent value in a list. Ties return the first seen."""
    ...
    def _builtin_percentile(self, args):
        """percentile(list, p) -> p-th percentile (0-100) using linear interpolation."""
    ...
    def _builtin_clamp(self, args):
        """clamp(value, lo, hi) -> value clamped to [lo, hi] range."""
    ...
    def _builtin_lerp(self, args):
        """lerp(a, b, t) -> linear interpolation between a and b at fraction t."""
    ...
    def _builtin_remap(self, args):
        """remap(value, in_lo, in_hi, out_lo, out_hi) -> remap value from one range to another."""
